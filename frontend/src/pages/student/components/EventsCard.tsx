...
export default function EventsCard({
  ...
  return (
    <Card className="h-full min-h-0 overflow-hidden">
      <CardHeader title="🎉 Holidays / Events" subtitle="Upcoming" />
          ...
          <div className="grid min-h-0 gap-2">
            {rows.map((e) => (
              ...
              >
                ...
                {e.description && e.description !== 'Holiday' && (
                  <div className="mt-0.5 truncate text-[11px] text-slate-500 dark:text-slate-400">{e.description}</div>
                )}
                <div className="mt-0.5 text-[11px] text-indigo-500 dark:text-indigo-400">
